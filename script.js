...
const translations = {
  ...
  'Mobile-first': ['Mobile-first', 'モバイルファースト'], 'SEO w standardzie': ['SEO included', 'SEO標準対応'], 'Jasna wycena': ['Transparent pricing', '明確な料金'], 'Szybki kontakt': ['Fast response', '迅速な対応'],
  ...
  'Strony, SEO i automatyzacje dla firm, które chcą rosnąć.': ['Websites, SEO and automation for businesses ready to grow.', '成長を目指す企業のためのウェブサイト、SEO、自動化。'], 'Kontakt': ['Contact', 'お問い合わせ'], 'Gdańsk · Polska': ['Gdańsk · Poland', 'グダニスク・ポーランド'], 'Dziękujemy — formularz demonstracyjny działa poprawnie.': ['Thank you — the demo form works correctly.', 'ありがとうございます。デモフォームは正常に動作しました。'],
